...
parseForErrors code = compileCollectFacts [simpleProcessor parseTokensProcessor, simpleProcessor parseASTProcessor, simpleProcessor parseModuleProcessor, simpleProcessor parseFASTProcessor] [("A", code)] selectErrors
...
parseForFunction code func = compileSelectFact [simpleProcessor parseTokensProcessor, simpleProcessor parseASTProcessor, simpleProcessor parseModuleProcessor, simpleProcessor parseFASTProcessor] [("A", code)] selectFact
