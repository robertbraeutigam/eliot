...
/** Compiler fact representing a function with uncurried typed expressions.
  *
  * This fact is generated after type checking and reverses the currying transformation, making function definitions and
  * applications use multiple parameters/arguments instead of nested single-parameter forms.
  */
