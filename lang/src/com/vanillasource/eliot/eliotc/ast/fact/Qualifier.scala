...
object Qualifier {
  ...
  /** Function belongs to the given ability implementation.
    *
    * The index disambiguates between multiple implementations of the same ability within one module;
    * the implementation's type pattern is encoded in the signature of the synthetic marker function
    * (the function whose local name equals the ability name) generated by the implement block.
    */
