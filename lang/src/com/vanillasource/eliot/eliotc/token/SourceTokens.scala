...
/** @param docComments
  ...
  *   inner text (delimiters excluded). They are kept out of [[tokens]] (the lexer discards all comments) and attached
  *   to the declaration each one precedes by [[com.vanillasource.eliot.eliotc.ast.processor.ASTParser]].
  */
