...
/** An [[OperatorResolvedValue]] whose source signature has been *saturated*: every parameter-position bare reference
  ...
  * inference.
  *
  * This is the fact every checker-phase reader of a value's *signature* consumes instead of [[OperatorResolvedValue]]
