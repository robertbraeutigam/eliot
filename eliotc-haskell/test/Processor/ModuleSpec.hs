...
parseMultiForErrors files = compileCollectFacts [simpleProcessor parseTokensProcessor, simpleProcessor parseASTProcessor, simpleProcessor parseModuleProcessor] files selectErrors
...
parseMultiForFact files = compileSelectFact [simpleProcessor parseTokensProcessor, simpleProcessor parseASTProcessor, simpleProcessor parseModuleProcessor] files selectFact
...
parseMultiForCompilationFunction files = compileCollectFacts [simpleProcessor parseTokensProcessor, simpleProcessor parseASTProcessor, simpleProcessor parseModuleProcessor] files selectFact
